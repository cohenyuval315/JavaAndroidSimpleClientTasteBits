...
public class CompletedOrdersFragment extends Fragment implements OrderInteract {
    private OrderAdapter orderAdapter;


    private String modalTitle = "Complete Order";

    private String okButtonName = "Ok";
    private String buttonName = "Read";
    private String fragTitle = "Completed Orders";
