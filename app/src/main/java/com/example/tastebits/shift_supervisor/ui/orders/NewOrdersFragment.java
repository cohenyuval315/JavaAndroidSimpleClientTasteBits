...
public class NewOrdersFragment extends Fragment implements OrderInteract {

    private OrderAdapter orderAdapter;


    private String modalTitle = "Accept Order?";
    private String positiveButtonName = "Accept";
    private String negativeButtonName = "Cancel";
    private String buttonName = "Accept Order";
    private String fragTitle = "New Orders";
