...
public class PendingOrdersFragment extends Fragment implements OrderInteract {
    private OrderAdapter orderAdapter;

    private String modalTitle = "Is Order Ready?";
    private String positiveButtonName = "Yes";
    private String negativeButtonName = "cancel";
    private String buttonName = "Order Ready";
    private String fragTitle = "Creating Orders Meals ";
